...
import { ReaderSettings, FontFamily, FontSize, Theme } from "../types";
          ...
          <div className="flex bg-gray-900 rounded-lg p-1">
            {(['sans', 'serif', 'mono'] as FontFamily[]).map((font) => (
              <button
                ...
                className={`flex-1 py-1 rounded-md text-sm capitalize transition-colors ${settings.fontFamily === font ? 'bg-gray-700 shadow-sm text-blue-400 font-medium' : 'text-gray-400 hover:text-gray-200'
                  }`}
              >
                {font}
              </button>
