                    ...
                    <div className="p-6 flex-1 flex flex-col gap-3">
                      <div className="flex items-start gap-2">
                        ...
                        <div className="relative">
                          <button
                            type="button"
                            className="p-2 rounded-full bg-gray-700/40 text-gray-300 hover:text-white hover:bg-gray-600 transition-all shadow-sm opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900 pointer-events-none group-hover:pointer-events-auto focus-visible:pointer-events-auto"
                          ...
                          {activeToolbarId === article.id && (
                            <div
                              className="absolute right-0 mt-2 w-32 rounded-lg border border-gray-700 bg-gray-900 shadow-lg z-20"
                              onClick={(e) => e.stopPropagation()}
                            >
                              <button
                                type="button"
                                className="w-full text-left px-4 py-2 text-sm text-red-400 hover:text-red-200 hover:bg-gray-800 rounded-lg disabled:opacity-50"
                                onClick={() => {
                                  if (deletingId) return;
          ...
          <div className="relative bg-gray-900 border border-gray-700 rounded-2xl shadow-2xl w-full max-w-md mx-4 p-6 space-y-4">
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                className="px-4 py-2 rounded-lg bg-red-600 text-white hover:bg-red-500 transition disabled:opacity-40"
              >
                {deletingId === articlePendingDelete.id ? 'Deleting...' : 'Delete'}
              </button>
            </div>
          </div>
        </div>
